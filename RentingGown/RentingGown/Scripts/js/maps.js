$(document).on('ready', function(){
	...
	var infowindow1 = new google.maps.InfoWindow({  
		content:  createInfo('<div class="listing-box"> <div class="listing-box-thumb"> <span class="price-list">$149.90</span> <img src="http://placehold.it/360x245" alt="" /> <div class="listing-box-title"> <h3><a href="#" title="">Sunpro Technology inc</a></h3> <span>Los Angeles /  Sillicon Valley </span> <span>(416) 551-0589</span> </div> </div> <div class="listing-rate-share"> <div class="rated-list"> <b class="la la-star"></b> <b class="la la-star"></b> <b class="la la-star"></b> <b class="la la-star-o"></b> <b class="la la-star-o"></b> <span>(13)</span> </div> <span><i class="la la-share-alt"></i></span> <a href="#" title=""><i class="la la-heart-o"></i></a> </div> </div>')
	}); 
